...
OUTPUT_DIR="/workspace/nvidia-resiliency-ext/experiments/straggler_injection/traces/${TIMESTAMP}_${INJECT_TYPE}_rank${INJECT_RANK}_${INJECT_DELAY_MS}ms"
...
num_iterations: 30' > ${OUTPUT_DIR}/run_config.log &&
  ...
  torchrun --nproc_per_node=8 \
    /workspace/nvidia-resiliency-ext/experiments/straggler_injection/run_simple_pp2_train_loop.py \
